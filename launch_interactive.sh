export BATCH_DIRECTORY=133
export TEST_MODEL_PATH='/scratch/groups/rubin/alimirz1/saved_batches/coco_50img_unsup_v2/saved_checkpoints/model_best_mAP.pt'
