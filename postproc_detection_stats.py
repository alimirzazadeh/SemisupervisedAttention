...
# define paths
PATH_EXPERIMENTS = '/scratch/groups/rubin/mpike27/saved_batches'
# FIRST_EXP = 'u226'
# SECOND_EXP = 'u226'
...
if __name__ == '__main__':
    ...
    FIRST_EXP = sys.argv[2]
    SECOND_EXP = sys.argv[3]
    ...
    # print all metrics
    metrics = ['overlap_gradcam_bbox'] #'overlap_gradcam_bbox', 'overlap_bbox_gb_bbox'] #['consistency', 'surface_bbox', 'overlap_gradcam_bbox',
