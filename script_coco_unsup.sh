...
export BATCH_DIRECTORY=coco_430img_top20_unsup_rebuttal
export TO_LOAD_CHECKPOINT=/scratch/groups/rubin/alimirz1/saved_batches/coco_sup430_top20_rebuttal/saved_checkpoints/model_best_mAP.pt
...
export NUM_IMAGES_PER_CLASS=430
