...
#SBATCH -e /scratch/groups/rubin/krish05m/AttentionMap/saved_batches/exp_krish32.err
#SBATCH -o /scratch/groups/rubin/krish05m/AttentionMap/saved_batches/exp_krish32.out

export BATCH_DIRECTORY=exp_krish32
