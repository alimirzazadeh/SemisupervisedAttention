...
#SBATCH -e /scratch/groups/rubin/krish05m/AttentionMap/saved_batches/exp_krish30.err
#SBATCH -o /scratch/groups/rubin/krish05m/AttentionMap/saved_batches/exp_krish30.out
export BATCH_DIRECTORY=exp_krish30
