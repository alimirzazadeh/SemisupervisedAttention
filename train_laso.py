...
def train(epochs=300, batch_size=16, images_per_class=2, eval_freq=10):
    suptrainloader, _, validloader, testloader = loadPascalData(images_per_class, data_dir='../data', download_data=False, batch_size=batch_size//2, useNewUnsupervised=False)
...
if __name__ == "__main__":
    laso_models = train(epochs=300, images_per_class=4)